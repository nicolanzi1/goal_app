...
RSpec.describe GoalsController, type: :controller do
    let(:jake) { User.create!(username: 'jake_lee', password: 'abcdef') }
    ...
    describe 'GET #new' do
        context 'when logged in' do
            before do
                allow(controller).to receive(:current_user) { jake }
            end
    ...
    describe 'POST #create' do
        let(:jake_lee) { User.create!(username: 'jake_lee', password: 'abcdef') }
        ...
        context 'when logged in' do
            before do
                allow(controller).to receive(:current_user) { jake_lee }
            end
